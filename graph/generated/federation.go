...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) ([]fedruntime.Entity, error) {
	...
	for _, rep := range representations {
		...
		case "Organization":
			...
			entity, err := ec.resolvers.Entity().FindOrganizationByID(ctx,
				id0)
			if err != nil {
				return nil, err
			}
		...
		case "Person":
			...
			entity, err := ec.resolvers.Entity().FindPersonByID(ctx,
				id0)
			if err != nil {
				return nil, err
			}
		...
		case "Team":
			...
			entity, err := ec.resolvers.Entity().FindTeamByID(ctx,
				id0)
			if err != nil {
				return nil, err
			}
